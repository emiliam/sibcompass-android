        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                for (XAPKFile xf : xAPKS) {
                    ...
                    if (!Helpers.doesFileExist(SibkompassiDownloaderActivity.this, fileName,
                            xf.mFileSize, false))
                        return false;
                    fileName = Helpers
                            .generateSaveFileName(SibkompassiDownloaderActivity.this, fileName);
                    ZipResourceFile zrf;
                            ...
                            if (-1 != entry.mCRC32) {
                                ...
                                try {
                                    ...
                                    while (length > 0) {
                                        ...
                                        if (timePassed > 0) {
                                            float currentSpeedSibkompassi = (float) seek
                                                    / (float) timePassed;
                                            if (0 != averageVerifySpeed) {
                                                averageVerifySpeed = SMOOTHING_FACTOR
                                                        * currentSpeedSibkompassi
                                                        + (1 - SMOOTHING_FACTOR)
                                                        * averageVerifySpeed;
                                            } else {
                                                averageVerifySpeed = currentSpeedSibkompassi;
                                            }
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                ...
                Intent intentToLaunchThisActivityFromNotification = new Intent(
                        SibkompassiDownloaderActivity
                        .this, SibkompassiDownloaderActivity.this.getClass());
